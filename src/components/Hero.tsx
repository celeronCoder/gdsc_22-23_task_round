  ...
  return (
    <div className="mt-20 flex flex-col gap-20">
      ...
      <div className="w-full flex items-center justify-center">
        <div className="flex items-center justify-between px-6 py-4 text-xl rounded-full max-w-sm text-black font-bold bg-gradient-to-r from-orange-400 to-indigo-400 w-full">
