  ...
  return (
    <div className="mt-20 flex flex-col gap-20">
      ...
      <div className="w-full flex items-center justify-center">
        <div className="flex items-center justify-between px-6 py-4 text-xl rounded-full max-w-sm font-bold bg-gradient-to-r hover:bg-gradient-to-l transition-all duration-300 cursor-pointer from-orange-400 to-indigo-600 w-full">
          <p>Explore Marketplace</p>
          <div className="p-3 bg-yellow-200 rounded-full font-extrabold">
            <div className="p-1 border-2 rounded-full text-black border-black">
